...
//         {label}
//       </label>
//       <div className="relative z-20 w-full bg-transparent rounded-md border border-stroke p-[2px] pr-8 text-graphite outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2">
//         <div
...
//             <span
//               key={`${label}-${index}`}
//               className="m-[5px] flex items-center justify-center rounded border-[.5px] border-stroke bg-gray-2 py-[7px] px-[20px] text-sm font-medium text-graphite relative"
//             >
//               {value}
//               <span
...
//         </div>
//         <select
//           className="absolute top-0 left-0 z-20 h-full w-full bg-light-grey text-graphite  opacity-0"
