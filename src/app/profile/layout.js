...
//           <button onClick={handleProfileClick} className="w-[50px] h-[37px] bg-gray-100 text-electric-blue border border-light-grey rounded-md mx-auto font-medium hover:bg-transparent ">
//             <Image className="mx-auto w-8" src="/assets/icons/onboarding/Hamburger.svg" alt="hamburger" width={20} height={20}/>
