// // app/manage-projects/pick-projects/page.js
// "use client";
...
//               >
//                 <div className="w-[200px] h-[200px] border-2 border-light-grey rounded-md flex justify-center items-center"  onClick={() => handleProjectClick(project)}>
//                   <Image
//                     src="/assets/images/projects.svg"
//                     alt={project.name}
//                     width={200}
...
// import React, { useState, useEffect } from "react";
// import Image from "next/image";  // Using Next.js Image component for static assets
// import { useSelectedProjects } from "../context";
...
//               <div className="w-[200px] h-[150px] border-2 border-light-grey rounded-md flex justify-center items-center">
//                 <Image
//                   src={project.path}  // Use local SVG path
//                   alt={project.name}
//                   width={200}
//                   height={200}
//                   className="object-contain"
...
//                   <Image
//                     src={project.path}  // Use local SVG path here too
//                     alt={project.name}
//                     width={200}
//                     height={200}
//                     className="object-contain"
...
//         <button
//           onClick={() => handleTabClick("instagram")}
//           className={`flex-1 py-2 text-lg font-semibold text-center flex items-center justify-center gap-2 ${selectedTab === "instagram" ? "text-electric-blue border-b-2 border-electric-blue" : "text-gray-500"}`}
//         >
//           Instagram
//         </button>
//         <button
//           onClick={() => handleTabClick("upload")}
//           className={`flex-1 py-2 text-lg font-semibold text-center flex items-center justify-center gap-2 ${selectedTab === "upload" ? "text-electric-blue border-b-2 border-electric-blue" : "text-gray-500"}`}
//         >
//           Upload
//         </button>
//       </div>
...
//         {selectedTab === "instagram" && renderInstagramTab()}
...
//           // Handle SVG files - Convert SVG to base64 string
//           const reader = new FileReader();
//           reader.onloadend = () => {
//             const base64data = reader.result;
//             // Save SVG file to localStorage as base64 string
//             localStorage.setItem(file.name, base64data);
//             handleFileUpload({ fileName: file.name, fileData: base64data });
//           };
//           reader.readAsDataURL(file);
//         } else if (file.type.startsWith("image/") || file.type.startsWith("video/")) {
//           // Handle image/video files - Convert to base64 string
//           const reader = new FileReader();
//           reader.onloadend = () => {
//             const base64data = reader.result;
//             // Save image/video file to localStorage as base64 string
//             localStorage.setItem(file.name, base64data);
//             handleFileUpload({ fileName: file.name, fileData: base64data });
//           };
//           reader.readAsDataURL(file);
