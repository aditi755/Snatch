...
//       return savedState ? JSON.parse(savedState) : { selectedProjects: [], instagramSelected: [], uploadedFiles: [] };
//     }
//     return { selectedProjects: [], instagramSelected: [], uploadedFiles: [] };
  
//   });

//   // Update state in localStorage whenever selectionState changes
//   useEffect(() => {
//     if (typeof window !== "undefined") {
...
//   const updateSelectionState = (newData) => {
//     setSelectionState((prev) => {
//       const updatedState = { ...prev, ...newData };
//       localStorage.setItem("selectionState", JSON.stringify(updatedState)); // Save updated state immediately
//       return updatedState;
//     });
//   };

//   // Handle the uploading of files (images, etc.)
...
//   // Add a project to selectedProjects
//   const addProject = (project) => {
//     updateSelectionState({
//       selectedProjects: [...selectionState.selectedProjects, project],
//     });
//   };

//   // Remove a project from selectedProjects
//   const removeProject = (projectId) => {
//     updateSelectionState({
//       selectedProjects: selectionState.selectedProjects.filter(
...
//   const clearProjects = () => {
//     updateSelectionState({ selectedProjects: [] });
//   };

//   // Add an Instagram selection
//   const addInstagramSelection = (selection) => {
//     updateSelectionState({
//       instagramSelected: [...selectionState.instagramSelected, selection],
//     });
//   };

//   // Remove an Instagram selection
