...
export default function EnterOtp() {
  ...
  const verifyOtp = async () => {
    ...
    try {
      // Verify OTP using Clerk's signIn method
      await signIn.attemptEmailAddressVerification({ code: otp.join("") });

      // On successful verification, redirect to onboarding or another page
